 ...
 * to different publisher sections. Requires authentication and publisher user type.
 * Redirects to home if user is not signed in or not a publisher.
 *
 * @example
 * // Route is automatically registered via createFileRoute
 * // Publishers navigate to /publisher/* to access publisher pages
 */
